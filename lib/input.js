...
Keyboard.prototype = {
	...
	_handleKeyPress: function (e) {
		debugkeyboard('_handleKeyPress() | enter');  // TODO: REMOVE
		if (!this._focused) { return true; }

		if (this._handler.keypress(e)) {
			debugkeyboard('_handleKeyPress() | calling this._handler.keypress(e)');  // TODO: REMOVE
			// Suppress bubbling/default actions
			Util.stopEvent(e);
			return false;
		} else {
			debugkeyboard('_handleKeyPress() | NON calling this._handler.keypress(e)');  // TODO: REMOVE
			// Allow the event to bubble and become a keyPress event which
			// will have the character code translated
			return true;
		}
